import 'package:AWC/screens/workers/create_worker/new_worker_view_model.dart';
...
class NewWorkerView extends StatelessWidget {
  const NewWorkerView({super.key});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<NewWorkerViewModel>.reactive(
      onViewModelReady: (model) async {
        await model.setBuildContext(context);
        await model.init();
      },
      viewModelBuilder: () => NewWorkerViewModel(),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: const InputDecoration(
                          isCollapsed: true,
                          hintText: 'Enter 10 Digit Mobile No (Required)',
                          hintStyle: TextStyle(
                              color: ColorManager.grey,
                              fontFamily: 'ProximaNova'
                          ),
  ...
  CupertinoActionSheet buildCupertinoActionSheet(BuildContext ctx, NewWorkerViewModel model) {
