...
import 'new_center_view_model.dart';

class NewCenterView extends StatelessWidget {
  const NewCenterView({super.key});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<NewCenterViewModel>.reactive(
    viewModelBuilder: () => NewCenterViewModel(),
  ...
  CupertinoActionSheet buildCupertinoActionSheet(BuildContext ctx, NewCenterViewModel model) {
